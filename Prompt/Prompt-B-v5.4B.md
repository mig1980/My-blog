...
5. **Performance Snapshot**
  ...
  -- Immediately after this paragraph, insert this placeholder comment ONLY:

     ```html
     <!-- PERFORMANCE TABLE EMBED START -->
     <!-- Performance table generated by Prompt C -->
     <!-- PERFORMANCE TABLE EMBED END -->
     ```

     **DO NOT generate the actual table HTML**. Prompt C will generate it separately.
...
6. **Performance Since Inception**
  ...
  -- 2–3 paragraphs (`text-gray-300 mb-6`):
   ...
   - Immediately after the paragraphs, insert this placeholder comment ONLY:

     ```html
     <!-- PERFORMANCE CHART EMBED START -->
     <!-- Performance chart generated by Prompt C -->
     <!-- PERFORMANCE CHART EMBED END -->
     ```

     **DO NOT generate the actual chart SVG or HTML**. Prompt C will generate it separately.
